...
def init_dataset(Revedges = True, Adddata = True, Addfunc = True, DataRefedgs = True, Calledges = True, CodeRefedgs = True, Laplacian_pe = False):
    dataset = iCallds4.iCallds2(Revedges=Revedges, Calledges=Calledges, Laplacian_pe=Laplacian_pe,
...
if __name__ == "__main__":
    epochs = 80
    # 图过于大
    # skips = [346,67,172,390,291]
    hidden_features = 512
    inslen = 60
    device = th.device("cuda" if th.cuda.is_available() else "cpu")
    exp_all(epochs = epochs, hidden_features=hidden_features, inslen = inslen,  savePATH = '/home/isec/model/resultofO160/allpe',
            Revedges = True, Adddata = True, Addfunc = True, DataRefedgs = True, Calledges = True, CodeRefedgs = True, Laplacian_pe=True)
    # exp_all(epochs = epochs, hidden_features=hidden_features, inslen = inslen,  savePATH = '/home/isec/model/compareExperiment50/dataedgecoderef',
    #         Revedges = False, Adddata = True, Addfunc = False, DataRefedgs = True, Calledges = False, CodeRefedgs = True, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, inslen = inslen,  savePATH = '/home/isec/model/compareExperiment90/pe',
    #         Revedges = False, Adddata = False, Addfunc = False, DataRefedgs = False, Calledges = False, CodeRefedgs = False, Laplacian_pe=True)

    # exp_all(epochs = epochs, hidden_features=hidden_features, inslen = inslen,  savePATH = '/home/isec/model/compareExperiment50/alloff',
    #         Revedges = False, Adddata = False, Addfunc = False, DataRefedgs = False, Calledges = False, CodeRefedgs = False, Laplacian_pe=False)
    #exp_all(epochs = epochs, hidden_features=hidden_features, inslen=inslen savePATH = '/home/isec/model/compareExperiment80/allpe',Revedges = True, Adddata = True, Addfunc = True, DataRefedgs = True, Calledges = True, CodeRefedgs = True, Laplacian_pe=True)
    #exp_all(epochs = epochs, hidden_features=hidden_features, inslen = inslen savePATH = '/home/isec/model/compareExperiment80/alloff',
    #       Revedges = False, Adddata = False, Addfunc = False, DataRefedgs = False, Calledges = False, CodeRefedgs = False, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, inslen = inslen,savePATH = '/home/isec/model/compareExperiment50/revedges',
    #         Revedges = True, Adddata = False, Addfunc = False, DataRefedgs = False, Calledges = False, CodeRefedgs = False, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, inslen=inslen, savePATH = '/home/isec/model/compareExperiment50/adddata',
    #         Revedges = False, Adddata = True, Addfunc = False, DataRefedgs = True, Calledges = False, CodeRefedgs = False, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, inslen = inslen, savePATH = '/home/isec/model/compareExperiment50/addfunc',
    #         Revedges = False, Adddata = False, Addfunc = True, DataRefedgs = False, Calledges = False, CodeRefedgs = False, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features,inslen = inslen, savePATH = '/home/isec/model/compareExperiment50/Calledges',
    #         Revedges = False, Adddata = False, Addfunc = False, DataRefedgs = False, Calledges = True, CodeRefedgs = False, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, inslen = inslen, savePATH = '/home/isec/model/compareExperiment50/codeRefedgs',
    #         Revedges = False, Adddata = False, Addfunc = False, DataRefedgs = False, Calledges = False, CodeRefedgs = True, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, inslen = inslen, savePATH = '/home/isec/model/compareExperiment50/allafter',
