...
def init_dataset(Revedges = True, Adddata = True, Addfunc = True, DataRefedgs = True, Calledges = True, CodeRefedgs = True, Laplacian_pe = False):
    dataset = iCallds6.iCallds2(Revedges=Revedges, Calledges=Calledges, Laplacian_pe=Laplacian_pe,
...
if __name__ == "__main__":
    ...
    exp_all(epochs = epochs, hidden_features=hidden_features, inslen = inslen,  savePATH = '/home/isec/model/resultofO360/allpe',
