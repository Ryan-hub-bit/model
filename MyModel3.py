...
def init_dataset(Revedges = True, Adddata = True, Addfunc = True, DataRefedgs = True, Calledges = True, CodeRefedgs = True, Laplacian_pe = False):
    dataset = iCallds3.iCallds2(Revedges=Revedges, Calledges=Calledges, Laplacian_pe=Laplacian_pe,
...
if __name__ == "__main__":
    epochs = 80
    # 图过于大
    skips = [394,1362,90,307,582,1393,1004]
    hidden_features = 512
    inslen = 60
    device = th.device("cuda" if th.cuda.is_available() else "cpu")
    exp_all(epochs = epochs, hidden_features=hidden_features, inslen = inslen,  savePATH = '/home/isec/model/resultoftotalgraph/allpe',
